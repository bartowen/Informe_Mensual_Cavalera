    ...
    <div className="bg-white rounded-xl shadow p-6">
      ...
      <div className="border-2 border-emerald-300 rounded-xl p-6 bg-gradient-to-br from-emerald-50 to-green-50">
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="w-16 h-16 bg-emerald-500 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
            <CheckCircle2 className="w-9 h-9 text-white" />
          </div>
          <div>
            <h4 className="text-2xl font-bold text-gray-900">Cavalera Search - Towen Ads</h4>
            <div className="flex flex-wrap items-center gap-3 mt-2">
              <span className="bg-emerald-200 text-emerald-900 text-sm px-3 py-1 rounded-full font-bold flex items-center gap-1">
                <Play className="w-4 h-4" />
                Activa
              </span>
              <span className="text-sm text-gray-600">Tipo: Búsqueda</span>
              <span className="text-sm text-gray-600">Presupuesto: $10.000/día</span>
            </div>
          </div>
        </div>
