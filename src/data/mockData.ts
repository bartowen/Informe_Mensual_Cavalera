...
export const searchTermsData: SearchTermData[] = [
  {
    searchTerm: 'tatuajes',
    triggeredKeyword: 'tatuajes arte',
    impressions: 759,
    clicks: 29,
    conversions: 10,
    cost: 7416,
  ...
  {
    searchTerm: 'cavalera tattoo',
    triggeredKeyword: 'AI Max',
    impressions: 1,
    clicks: 1,
    conversions: 3,
    cost: 256,
  ...
  {
    searchTerm: 'tatuadores santiago',
    triggeredKeyword: 'tatuajes santiago',
    impressions: 130,
    clicks: 35,
    conversions: 3,
  ...
  {
    searchTerm: 'nosferatu tattoo',
    triggeredKeyword: 'estudio de tatuajes',
    impressions: 3,
    clicks: 1,
    conversions: 2,
    cost: 256,
  ...
  {
    searchTerm: 'calavera tattoo',
    triggeredKeyword: 'tatuajes minimalistas',
    impressions: 8,
    clicks: 2,
    conversions: 2,
    cost: 512,
  ...
  {
    searchTerm: 'tatuadores san miguel',
    triggeredKeyword: 'estudio de tatuajes',
    impressions: 3,
    clicks: 1,
    conversions: 2,
...
// SUMA: 40 conversiones - DATOS REALES del CSV de Google Ads
